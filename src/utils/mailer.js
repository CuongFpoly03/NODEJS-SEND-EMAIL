...
const adminEmail =
  "Thay thế chuỗi string này thành địa chỉ admin email của bạn.";
const adminPassword =
  "Thay thế chuỗi string này thành mật khẩu admin email của bạn.";
...
const sendMail = (to, subject, htmlContent) => {
  ...
  const options = {
    from: adminEmail,// địa chỉ admin email để gửi
